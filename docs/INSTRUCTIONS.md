...
# C.R.U.D. webformulier

Ontwerp en maak een webformulier om data van een bestaande API te beheren.

## Context

Deze leertaak hoort bij sprint 7 "Connect Your Tribe". Dit is een autonome opdracht die je in zelfstandig of in een team uitvoert voor FDND.
